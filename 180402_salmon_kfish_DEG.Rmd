...
y$counts - mean_counts + grandmean
...
d2 <- d[!(d$Gene %in% g$Gene),]
e2 <- e[!(e$Gene %in% g$Gene),]
f2 <- f[!(f$Gene %in% g$Gene),]
...
write.table(d2, "~/Documents/NIEHS_LSU_UCD/rnaseq/Ranalysis/180628_adjp005_group_exposure.csv", col.names=TRUE, row.names=FALSE, sep=",")
write.table(e2, "~/Documents/NIEHS_LSU_UCD/rnaseq/Ranalysis/180628_adjp005_group_stage.csv", col.names=TRUE, row.names=FALSE, sep=",")
write.table(f2, "~/Documents/NIEHS_LSU_UCD/rnaseq/Ranalysis/180628_adjp005_exposure_stage.csv", col.names=TRUE, row.names=FALSE, sep=",")
write.table(g, "~/Documents/NIEHS_LSU_UCD/rnaseq/Ranalysis/180628_adjp005_group_exposure_stage.csv", col.names=TRUE, row.names=FALSE, sep=",")
