#!/bin/bash -l
#SBATCH --array=1-175%50
#SBATCH -D /home/jajpark/niehs/final_scripts/
#SBATCH -o /home/jajpark/niehs/slurm-log/191110_bwaars-stout-%A-%a.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/191110_bwaars-stderr-%A-%a.txt
#SBATCH -J bwa_align
#SBATCH -p high
#SBATCH -t 24:00:00 
