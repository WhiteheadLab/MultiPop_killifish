#!/bin/bash -l
#SBATCH --array=1-664%50
#SBATCH -D /home/jajpark/niehs/final_scripts/
#SBATCH -o /home/jajpark/niehs/slurm-log/191217-bwapops-stout-%A-%a.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/191217-bwapops-stderr-%A-%a.txt
#SBATCH -J bwa_pops
#SBATCH -p high
#SBATCH -t 24:00:00 
...
rg=$(echo \@RG\\tID:$flowcell.$lane.$samp\\tPL:Illumina\\tPU:$flowcell.$lane.$sampbarcode\\tLB:$samp\\tSM:$samp)
