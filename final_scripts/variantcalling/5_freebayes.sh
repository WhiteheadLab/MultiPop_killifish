#!/bin/bash 
#SBATCH --array=1-11467%30
#SBATCH -D /home/jajpark/niehs/final_scripts/
#SBATCH -o /home/jajpark/niehs/slurm-log/200124-freebayes-stout-%A-%a.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/200124-freebayes-stderr-%A-%a.txt
#SBATCH -J freeb
#SBATCH -p high
#SBATCH -t 24:00:00 
...
echo This task will analyze region $REGION of the f. heteroclitus genome. 
...
-f $GEN \
-L bamlist.txt \
-r $REGION > $outdir/var_${REGION}.vcf
