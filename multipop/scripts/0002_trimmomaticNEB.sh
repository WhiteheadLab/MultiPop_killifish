...
#SBATCH -o /home/jajpark/niehs/slurm-log/trimstout-%j.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/trim-stderr-%j.txt
#SBATCH -J trim
# last modifed 2016 augst 1
set -e
set -u


DIR="/home/jajpark/niehs/Data/Data/"
outdir="/home/jajpark/niehs/Data/lanes1-6_nebtrim/"
