...
do
	...
	echo `STAR --genomeDir /home/jajpark/niehs/align/star-index-hetannot/ --runThreadN 24 --readFilesCommand zcat --readFilesIn ${dir}/${base}_R1_001.qc.fq.gz ${dir}/${base}_R2_001.qc.fq.gz --outFileNamePrefix $outdir/$base`
