...
OUTDIR2=~/niehs/results/htseqcount/exons
cd $DIR

gff=~/niehs/refseq/GCF_000826765.1_Fundulus_heteroclitus-3.0.2_genomic.gff
...
htseq-count --format=bam -i ID -t exon $f $gff > ${OUTDIR2}/$count
