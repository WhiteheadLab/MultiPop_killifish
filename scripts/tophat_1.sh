...
#SBATCH -o /home/jajpark/niehs/slurm-log/tpht1-stout-%j.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/tpht1-stderr-%j.txt
#SBATCH -J tpht1
...
transcript_annotation="/home/jajpark/niehs/refseq/GCF_000826765.1_Fundulus_heteroclitus-3.0.2_genomic.gff"
dir="/home/jajpark/niehs/Data/trim"
outdir="/home/jajpark/niehs/results/tophat"
...
# 	echo $base
# 	
# 	echo `tophat -G ${transcript_annotation} -o ${outdir}/${base} --no-novel-juncs ${reference_index} ${dir}/${base}_R1_001.qc.fq ${dir}/${base}_R2_001.qc.fq`
# 	
# done
