...
#SBATCH -o /home/jajpark/niehs/slurm-log/fastqcb-stout-%j.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/fastqcb-stderr-%j.txt
#SBATCH -J fastqc2
set -e
set -u
...
logPath=$DIR/logs/$(basename fastqcb.sh).log
##
