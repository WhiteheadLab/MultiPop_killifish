...
#SBATCH -o /home/jajpark/niehs/slurm-log/180123_salmcountk21-stout-%A-%a.txt
#SBATCH -e /home/jajpark/niehs/slurm-log/180123_salmcountk21-stderr-%A-%a.txt
#SBATCH -J salmcount_kfish_k21
#SBATCH --mem=6000
#SBATCH -p med
#SBATCH -t 24:00:00 
...
IND=~/niehs/refseq/kfish_salm_index_k21
OUTDIR=~/niehs/results/180123_kfishind_k21_salmcounts
